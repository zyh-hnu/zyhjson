...
static void test_parse_invalid_unicode_hex() {
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u0\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u01\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u012\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u/000\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\uG000\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u0/00\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u0G00\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u00/0\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u00G0\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u000/\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_HEX, "\"\\u000G\"");
}

static void test_parse_invalid_unicode_surrogate() {
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_SURROGATE, "\"\\uD800\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_SURROGATE, "\"\\uDBFF\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_SURROGATE, "\"\\uD800\\\\\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_SURROGATE, "\"\\uD800\\uDBFF\"");
    TEST_ERROR(ZYH_PARSE_INVALID_UNICODE_SURROGATE, "\"\\uD800\\uE000\"");
...
static void test_parse() {
    ...
    test_parse_invalid_unicode_hex();//测试无效的\u+XXXX
    test_parse_invalid_unicode_surrogate();//测试无效高代理和低代理对
